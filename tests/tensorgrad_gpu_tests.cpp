...
int main() {
    ...
    // test 38: MaxPool2D forward and backward CPU vs GPU parity
    {
        ...
        auto pool_cpu = std::make_shared<MaxPool2D>(K, stride);
        auto pool_gpu = std::make_shared<MaxPool2D>(K, stride);
